  ...
  return (
    <main className="bg-[#f6f1e7] flex flex-col items-center p-6">
      <h1 className="w-full flex flex-col items-end text-[#730217] text-xl sm:text-2xl text-shadow-lg mb-6">
        <span className="font-semibold">ตารางกิจกรรมประจำวัน</span>
      ...
      <div className="bg-black w-full p-4 rounded">
        <section className="bg-white p-6">
          ...
          <div className="w-full mt-10">
            <div className="flex justify-between font-bold text-xl sm:text-2xl mb-4 text-[#730217]">
                    ...
                    return (
                      ...
                      >
                        <td className="p-3 border font-medium">
                          ...
                          {ev.title}
                          <button className="bg-red-600 text-white text-xs px-3 py-1 rounded-full shadow">
                            อ่านเพิ่มเติม
                          </button>{" "}
                          </div>
                        </td>
